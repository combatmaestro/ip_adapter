# Refactored `ip_adapter.py` with local-only image encoder loading
...
class IPAdapter:
    def __init__(self, sd_pipe, image_encoder_path, ip_ckpt, device, num_tokens=4):
        ...
        # load image encoder from local directory manually
        config_path = os.path.join(self.image_encoder_path, "config.json")
        weights_path = os.path.join(self.image_encoder_path, "pytorch_model.bin")
    ...
    def generate(
        ...
        **kwargs
        ...
        raise NotImplementedError("Use subclass like IPAdapterXL")
